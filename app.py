...
def load_all_data():
    ...
    if bls_df.empty and ilo_df is not None:
        bls_df = ilo_df
...
page = st.sidebar.radio("Navigate", ("Data Overview", "BLS Salary Model"))
st.sidebar.markdown("---")
...
if page == "Data Overview":
    ...
    st.write("Predict expected salary using job title, region, and experience level based on BLS data.")
